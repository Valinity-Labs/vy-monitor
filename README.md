...
| Ambiente | URL |
|----------|-----|
| **Mainnet** (default) | `https://valinity-labs.github.io/vy-monitor/` |
| **Mainnet** | `https://valinity-labs.github.io/vy-monitor/?network=mainnet` |
| **Testnet** | `https://valinity-labs.github.io/vy-monitor/?network=sepolia` |
